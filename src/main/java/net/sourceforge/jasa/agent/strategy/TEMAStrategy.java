 ...
 *          : http://www.investopedia.com/terms/t/triple-exponential-moving-average.asp
 *
 */
public class TEMAStrategy extends AbstractTradingStrategy {
    ...
    private PlaceOrder inMarketSignal(Double currentPrice){
        ...
        RetCode retCode = core.ppo(0, closePrice.length - 1,closePrice, QUICK_PERIODS_AVERAGE, SLOW_PERIODS_AVERAGE,
                MAType.Tema, signalSMABegin, signalSMALength, out);
